...
#ifdef __EMSCRIPTEN__
typedef double_int53_t WGpuBufferRange;
#else
typedef void* WGpuBufferRange;
#endif
WGpuBufferRange wgpu_buffer_get_mapped_range(WGpuBuffer buffer, double_int53_t startOffset, double_int53_t size _WGPU_DEFAULT_VALUE(WGPU_MAP_MAX_LENGTH));
void wgpu_buffer_read_mapped_range(WGpuBuffer buffer, WGpuBufferRange startOffset, double_int53_t subOffset, void *dst NOTNULL, double_int53_t size);
void wgpu_buffer_write_mapped_range(WGpuBuffer buffer, WGpuBufferRange startOffset, double_int53_t subOffset, const void *src NOTNULL, double_int53_t size);
